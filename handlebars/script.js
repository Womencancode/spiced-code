(function() {
    ...
    //     name: "Sasssafrass",
    //     nickName: "Sassys",
    //     favouriteFoods: ["pizza", "chocolate", "candy", "sushi"]
    // };
    // $(".sassafrass-info").html(Handlebars.templates.sassafrass(sassafrassObj));
    ...
    $(".dogs-info").html(Handlebars.templates.dogs(dogsData));
})();
